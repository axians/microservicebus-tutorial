...
var exports = module.exports = {
    ...
    Start: function () {
        ...
        self.Debug('Started function');
        let msgSendInterval = this.GetPropertyValue('static', 'msgSendInterval');
        self.Debug('msgSendInterval = ' + msgSendInterval /1000 + ' seconds');
    ...
    Process: function (message, context) {
        ...
        // self.SubmitResponseMessage(msg, context, 'application/json');
